# AI-Driven Egg Counting & Quality Grading System developed using real running conveyor footage. 
The service include below all points:
•	Real-time automated egg counting
...
-Multi-object tracking to prevent duplicate counting 
• Automatic egg counting based on virtual line-crossing logic 
• Size classification (Small / Medium / Large) 
• Broken egg detection and flagging 
• Confidence-based filtering to ensure reliability 
• Edge-to-server synchronization for data storage and reporting 
<img width="1002" height="556" alt="image" src="https://github.com/user-attachments/assets/2abf23cb-15d3-4e01-8e92-1fde7ccbe2ba" />
...
• 64GB DDR4/DDR5 RAM 
• 512GB or 1TB NVMe SSD (Primary Storage) 
• 1TB HDD (Logs and historical data storage) 
• Thermaltake 1200W High-Efficiency Power Supply 
